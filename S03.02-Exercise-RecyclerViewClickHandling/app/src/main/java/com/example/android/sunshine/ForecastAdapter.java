...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    private final ForestAdapterOnClickHandler mClickHandler;
    ...
    public interface ForestAdapterOnClickHandler{
    ...
    public ForecastAdapter(ForestAdapterOnClickHandler forestAdapterOnClickHandler) {
        mClickHandler = forestAdapterOnClickHandler;
    }
