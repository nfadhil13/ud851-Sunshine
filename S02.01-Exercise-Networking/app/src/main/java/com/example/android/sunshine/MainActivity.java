...
public class MainActivity extends AppCompatActivity {
    ...
    class FetchWeatherTask extends AsyncTask<String , Void , String[]>{
        ...
        protected String[] doInBackground(String... strings) {
            ...
            try{
                String jsonWeatherRespone = NetworkUtils.getResponseFromHttpUrl(weatherRequestUrl);

                String[] extractJsonWeather = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this ,
                        jsonWeatherRespone);

                return extractJsonWeather;
            }catch (Exception e){
                e.printStackTrace();
                return null;
            }
        ...
        protected void onPostExecute(String[] result){
            if(result!=null){
                for(String resultsString : result){
                    mWeatherTextView.append(resultsString + "\n\n\n");
                }
            }
        }
    }
